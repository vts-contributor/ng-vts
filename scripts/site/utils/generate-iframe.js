...
const zorroModule = String(fs.readFileSync(path.resolve(__dirname, '../template/ng-vts.module.template.ts')));
...
module.exports = function (iframeTargetPath, componentsMap) {
  ...
  fs.writeFileSync(path.join(iframeTargetPath, `ng-vts.module.ts`), zorroModule);
};
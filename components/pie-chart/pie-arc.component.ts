...
export class PieArcComponent implements OnChanges {
  ...
  @Output() select = new EventEmitter<VtsPieChartItem>();
  @Output() activate = new EventEmitter<VtsPieChartItem>();
  @Output() deactivate = new EventEmitter<VtsPieChartItem>();
  @Output() dblclick = new EventEmitter<{nativeEvent: MouseEvent, data: VtsPieChartItem}>();

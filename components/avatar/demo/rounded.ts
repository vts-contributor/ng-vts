...
@Component({
  selector: 'vts-demo-avatar-rounded',
  template: `
    <div vts-space vtsDirection="vertical" vtsPreset="4">
      ...
      <div *vtsSpaceItem vts-space vtsPreset="3" vtsAlign="center" vtsWrap>
        <vts-avatar *vtsSpaceItem vtsSize="xxs" vtsShape="rounded" [vtsSrc]="image"></vts-avatar>
        <vts-avatar *vtsSpaceItem vtsSize="xs" vtsShape="rounded" [vtsSrc]="image"></vts-avatar>
        <vts-avatar *vtsSpaceItem vtsSize="sm" vtsShape="rounded" [vtsSrc]="image"></vts-avatar>
        <vts-avatar *vtsSpaceItem vtsSize="md" vtsShape="rounded" [vtsSrc]="image"></vts-avatar>
        <vts-avatar *vtsSpaceItem vtsSize="lg" vtsShape="rounded" [vtsSrc]="image"></vts-avatar>
        <vts-avatar *vtsSpaceItem vtsSize="xl" vtsShape="rounded" [vtsSrc]="image"></vts-avatar>
      </div>
    </div>
  `
})
export class VtsDemoAvatarRoundedComponent {
  image =

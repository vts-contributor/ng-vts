...
const isFirefox = isBrowser && (window as VtsSafeAny).mozInnerScreenX != null;
...
export function getCaretCoordinates(
  ...
  const computed = window.getComputedStyle
    ...
    : (element as VtsSafeAny).currentStyle; // currentStyle for IE < 9
...
export function createDebugEle(
  ...
  const rect: HTMLSpanElement =
    (document.querySelector('#DEBUG') as HTMLSpanElement) || document.createElement('div');

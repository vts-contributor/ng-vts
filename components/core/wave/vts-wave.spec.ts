...
import { VtsWaveModule } from './vts-wave.module';

const WAVE_ATTRIBUTE_NAME = 'vts-click-animating-without-extra-node';
const WAVE_ATTRIBUTE_NAME_EXTRA_NODE = 'vts-click-animating';
const EXTRA_NODE_CLASS_NAME = '.vts-click-animating-node';

describe('vts-wave base', () => {
  let fixture: ComponentFixture<WaveContainerWithButtonComponent>;
  let waveTarget: HTMLElement;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [VtsWaveModule],
...
describe('vts-wave NoopAnimationsModule', () => {
  let fixture: ComponentFixture<WaveContainerWithButtonComponent>;
  let waveRef: VtsWaveDirective;
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [VtsWaveModule, NoopAnimationsModule],
      declarations: [WaveContainerWithButtonComponent]
    });
  });
...
describe('vts-wave disable/enable', () => {
  let fixture: ComponentFixture<WaveContainerWithButtonComponent>;
  let waveTarget: HTMLElement;
  let waveRef: VtsWaveDirective;
  beforeEach(() => {
...
class WaveContainerWithButtonComponent {
  ...
  @ViewChild(VtsWaveDirective, { static: false }) wave!: VtsWaveDirective;
}

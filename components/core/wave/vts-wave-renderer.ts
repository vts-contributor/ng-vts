...
export class VtsWaveRenderer {
  ...
  get waveAttributeName(): string {
    return this.insertExtraNode ? 'vts-click-animating' : 'vts-click-animating-without-extra-node';
  }
  ...
  private fadeOutWave(): void {
    ...
    if (this.insertExtraNode) {
      ...
      this.extraNode.className = 'vts-click-animating-node';

...
export class VtsSingletonService {
  ...
  registerSingletonWithKey(key: string, target: VtsSafeAny): void {
  ...
  private withNewTarget(target: VtsSafeAny): SingletonRegistryItem {
    return {
      target
    };
  }

...
export interface VtsScrollToOptions {
...
export class VtsScrollService {
  private doc: Document;

  constructor(@Inject(DOCUMENT) doc: VtsSafeAny) {
    this.doc = doc;
  }
  ...
  getScroll(
    target?: Element | HTMLElement | Window | Document | null,
    top: boolean = true
  ): number {
  ...
  isWindow(obj: VtsSafeAny): boolean {

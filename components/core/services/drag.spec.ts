...
import { VtsDragService } from '@ui-vts/ng-vts/core/services';
...
export class VtsTestDragServiceComponent {
  drag$ = new Subject<void>();
  complete$ = new Subject<void>();

  constructor(public readonly vtsDragService: VtsDragService) {}
...
describe('drag service', () => {
  let fixture: ComponentFixture<VtsTestDragServiceComponent>;
  let component: VtsTestDragServiceComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [VtsTestDragServiceComponent]
    });
  ...
  describe('basics', () => {
    beforeEach(() => {
      fixture = TestBed.createComponent(VtsTestDragServiceComponent);

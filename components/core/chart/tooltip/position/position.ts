...
export class PositionHelper {
   ...
   * @memberOf PositionHelper
   */
  static positionCaret(placement: PlacementTypes, elmDim: DOMRect, hostDim: DOMRect, caretDimensions: DOMRect, alignment: PlacementTypes): any {
    let top = 0;
    let left = 0;
   ...
   * @memberOf PositionHelper
   */
  static positionContent(placement: PlacementTypes, elmDim: DOMRect, hostDim: DOMRect, spacing: number, alignment: PlacementTypes): any {
    let top = 0;
    let left = 0;

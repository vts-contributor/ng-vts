...
export class TooltipArea {
  ...
  @ViewChild('tooltipAnchor', { static: false }) tooltipAnchor!: ElementRef<any>;
  ...
  getValues(xVal: any): Tooltip[] {
    ...
    for (const group of this.results) {
      const item = group.series.find((d: {name: string}) => d.name.toString() === xVal.toString());
  ...
  mouseMove(event: MouseEvent) {
    ...
    const xPos = event.pageX - (event.target as HTMLElement).getBoundingClientRect().left;

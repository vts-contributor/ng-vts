...
@Component({
  selector: 'vts-demo-descriptions-vertical-border',
  template: `
    <vts-descriptions vtsTitle="User Info" vtsBordered vtsLayout="vertical">
...
export class VtsDemoDescriptionsVerticalBorderComponent {}

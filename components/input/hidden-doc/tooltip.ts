...
@Component({
  selector: 'vts-demo-input-tooltip',
  ...
  template: `
    <input
      ...
      vts-input
      vts-tooltip
      vtsTooltipTrigger="focus"
      vtsTooltipPlacement="topLeft"
      vtsOverlayClassName="numeric-input"
      [ngModel]="value"
  ...
  styles: [
    `
      .numeric-input .vts-tooltip-inner {
        min-width: 32px;
        min-height: 37px;
      }
...
export class VtsDemoInputTooltipComponent {
  value = '';

...
export class VtsImagePreviewComponent implements OnInit, OnDestroy {
  ...
  addIcons() {
    this.iconService.addIcon({
      ...
      name: 'AvatarPreviewRotateLeft:avatar'
    });
    this.iconService.addIcon({
    ...
    this.iconService.addIcon({
      ...
      name: 'AvatarPreviewRotateRight:avatar'
    });
    this.iconService.addIcon({
      ...
      name: 'AvatarPreviewZoomOut:avatar'
    });
    this.iconService.addIcon({
      ...
      name: 'AvatarPreviewZoomIn:avatar'
    });
    this.iconService.addIcon({
      ...
      name: 'AvatarPreviewClose:avatar'
    });
  }

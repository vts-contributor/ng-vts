...
@Component({
  selector: 'vts-demo-checkbox-mobile',
  template: `
    <form [vtsLayout]="'vertical'" vts-form>
      <vts-form-item>
        ...
        <vts-form-control>
          <vts-checkbox-wrapper (vtsOnChange)="print($event)">
            <vts-space vtsPreset="4" vtsDirection="vertical">
      ...
      <vts-form-item>
        ...
        <vts-form-control>
          <vts-checkbox-wrapper (vtsOnChange)="print($event)">
            <vts-space vtsPreset="3" vtsDirection="vertical">
...
export class VtsDemoCheckboxMobileComponent {
  print(e: string[]) {
    console.log(e);
  }
}

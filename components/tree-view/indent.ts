...
@Component({
  ...
  template: `
    <span
      ...
      [class.vts-tree-indent-unit-end]="!isEnd"
...
@Directive({
  selector: 'vts-tree-node[vtsTreeNodeIndentLine]',
  host: {
    class: 'vts-tree-show-line',
    '[class.vts-tree-treenode-leaf-last]': 'isLast && isLeaf'
  }
})
export class VtsTreeNodeIndentLineDirective<T> implements OnDestroy {

...
@Component({
  selector: '[vts-sider-trigger]',
  exportAs: 'vtsSiderTrigger',
  ...
  `,
  host: {
    '[class.vts-layout-sider-trigger]': 'isNormalTrigger',
    '[style.width]': 'isNormalTrigger ? siderWidth : null',
    '[class.vts-layout-sider-zero-width-trigger]': 'isZeroTrigger',
    '[class.vts-layout-sider-zero-width-trigger-right]': 'isZeroTrigger && vtsReverseArrow',
    '[class.vts-layout-sider-zero-width-trigger-left]': 'isZeroTrigger && !vtsReverseArrow'
  }
})

...
@Component({
  ...
  `,
  providers: [VtsResizeObserver],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class VtsOverflowContainerComponent implements OnInit, AfterContentInit, OnDestroy {
  contentInit$ = new Subject<void>();
  @ContentChildren(VtsOverflowItemDirective)
  overflowItems: QueryList<VtsOverflowItemDirective> | undefined = undefined;
  @ContentChild(VtsOverflowSuffixDirective)
  overflowSuffix: VtsOverflowSuffixDirective | undefined = undefined;
  @ContentChild(VtsOverflowRestDirective) overflowRest: VtsOverflowRestDirective | undefined =
    undefined;
  overflowItems$ = new ReplaySubject<QueryList<VtsOverflowItemDirective>>(1);

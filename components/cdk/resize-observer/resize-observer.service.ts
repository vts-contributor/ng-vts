...
export class VtsResizeObserverFactory {
...
@Injectable({ providedIn: 'root' })
export class VtsResizeObserver implements OnDestroy {
  ...
  constructor(private nzResizeObserverFactory: VtsResizeObserverFactory) {}
